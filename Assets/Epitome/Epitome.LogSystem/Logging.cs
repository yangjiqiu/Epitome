...
namespace Epitome.LogSystem
{
    ...
    public class Logging : Singleton<Logging>
    {
        ...
        {
            LogRecord(LogLevel.TRACE, message, StackTrace.ToString());
        }
        public void Trace(string format, params object[] args)
        {
            LogRecord(LogLevel.TRACE, string.Format(format, args), StackTrace.ToString());
        }

        public void Debug(object message)
        {
            LogRecord(LogLevel.DEBUG, message, StackTrace.ToString());
        }
        public void Debug(string format, params object[] args)
        {
            LogRecord(LogLevel.DEBUG, string.Format(format, args), StackTrace.ToString());
        }
        ...
        {
            LogRecord(LogLevel.INFO, string.Format(format, args), StackTrace.ToString());
        }
        ...
        {
            LogRecord(LogLevel.WARN, message, StackTrace.ToString());
        }
        public void Warn(string format, params object[] args)
        {
            LogRecord(LogLevel.WARN, string.Format(format, args), StackTrace.ToString());
        }
        ...
        {
            LogRecord(LogLevel.ERROR, message, StackTrace.ToString());
        }
        public void Error(string format, params object[] args)
        {
            LogRecord(LogLevel.ERROR, string.Format(format, args), StackTrace.ToString());
        }
        ...
        {
            LogRecord(LogLevel.FATAL, message, StackTrace.ToString());
        }
        public void Fatal(string format, params object[] args)
        {
            LogRecord(LogLevel.FATAL, string.Format(format, args), StackTrace.ToString());
        }
        ...
        private string GetBriefnessTrack(System.Diagnostics.StackFrame frame)
        {
            return string.Format("File: {0} - Line:{1,3}", frame.GetFileName(), frame.GetFileLineNumber());
        }

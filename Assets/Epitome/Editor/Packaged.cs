...
namespace Epitome.Utility
{
    ...
    public static class Packaged
    {
        ...
        {
            // 打开保存面板，获得用户选择的路径  
            string saveFilePanel = EditorUtility.OpenFolderPanel("Open Folder", Application.dataPath , "");
            ...
            //{
                ...
                AssetBundleManifest manifest = BuildPipeline.BuildAssetBundles(saveFilePanel, BuildAssetBundleOptions.None, buildTarget);
